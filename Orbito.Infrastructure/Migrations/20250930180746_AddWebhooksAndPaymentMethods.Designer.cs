...
namespace Orbito.Infrastructure.Migrations
{
    ...
    [Migration("20250930180746_AddWebhooksAndPaymentMethods")]
    partial class AddWebhooksAndPaymentMethods
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Orbito.Domain.Entities.PaymentWebhookLog", b =>
                {
                    ...
                    b.HasIndex("ProcessedAt")
                        .HasDatabaseName("IX_PaymentWebhookLogs_ProcessedAt");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_PaymentWebhookLogs_Status");

                    b.HasIndex("EventType", "ProcessedAt")
                        .HasDatabaseName("IX_PaymentWebhookLogs_EventType_ProcessedAt");

                    b.HasIndex("Provider", "Status")
                        .HasDatabaseName("IX_PaymentWebhookLogs_Provider_Status");
