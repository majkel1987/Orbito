...
/// <summary>
/// Validator for GetFailureReasonsQuery
/// </summary>
public class GetFailureReasonsQueryValidator : AbstractValidator<GetFailureReasonsQuery>
{
    ...
    private static bool HaveValidDateRange(GetFailureReasonsQuery query)
    {
    ...
    private static bool StartDateNotInFuture(GetFailureReasonsQuery query)
    {
        return query.StartDate <= DateTime.UtcNow.AddDays(1); // Allow 1 day buffer for timezone differences
    }

    private static bool EndDateNotInFuture(GetFailureReasonsQuery query)
    {
