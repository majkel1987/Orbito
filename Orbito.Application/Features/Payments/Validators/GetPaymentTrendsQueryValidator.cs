...
/// <summary>
/// Validator for GetPaymentTrendsQuery
/// </summary>
public class GetPaymentTrendsQueryValidator : AbstractValidator<GetPaymentTrendsQuery>
{
    private const int MaxDateRangeDays = 365; // Maximum 1 year
    private const int MinDateRangeDays = 1;   // Minimum 1 day

    public GetPaymentTrendsQueryValidator()
    {
        // Date validation
    ...
    private static bool HaveValidDateRange(GetPaymentTrendsQuery query)
    {
    ...
    private static bool StartDateNotInFuture(GetPaymentTrendsQuery query)
    {
        return query.StartDate <= DateTime.UtcNow.AddDays(1); // Allow 1 day buffer for timezone differences
    }

    private static bool EndDateNotInFuture(GetPaymentTrendsQuery query)
    {
