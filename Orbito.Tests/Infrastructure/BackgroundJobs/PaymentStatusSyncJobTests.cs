...
[Trait("Category", "Unit")]
public class PaymentStatusSyncJobTests : IDisposable
{
    private readonly IServiceProvider _mockServiceProvider;
    private readonly Mock<ILogger<PaymentStatusSyncJob>> _mockLogger;
    ...
    private readonly PaymentStatusSyncJob _job;

    public PaymentStatusSyncJobTests()
    {
        _mockLogger = new Mock<ILogger<PaymentStatusSyncJob>>();
        ...
        _job = new PaymentStatusSyncJob(_mockServiceProvider, _mockLogger.Object, TimeSpan.FromMilliseconds(100));
    }
    ...
    [Fact]
    public async Task Execute_HasActiveTenants_ShouldSyncPaymentStatuses()
    {
        // Arrange
        ...
        _mockPaymentService
            .Setup(x => x.SyncPaymentStatusesWithStripeAsync(
                It.IsAny<DateTime>(),
        ...
        _mockPaymentService.Verify(
            x => x.SyncPaymentStatusesWithStripeAsync(
                It.IsAny<DateTime>(),
                It.IsAny<CancellationToken>()),
            Times.AtLeastOnce);
    ...
    [Fact]
    public async Task Execute_SyncFails_ShouldLogErrorAndContinue()
    {
        // Arrange
        var userId = Guid.NewGuid();
        var provider = Provider.Create(
    ...
    [Fact]
    public async Task Execute_MultipleActiveTenants_ShouldSyncAllTenants()
    {
        // Arrange
    ...
    [Fact]
    public async Task Execute_SyncTimesOut_ShouldLogWarningAndContinue()
    {
        // Arrange
        var userId1 = Guid.NewGuid();
        var userId2 = Guid.NewGuid();
